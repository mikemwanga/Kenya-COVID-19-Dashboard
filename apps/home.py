...
@app.callback(
    Output("home-content","children"), Input("interval-component", "n_intervals")
)
...
def update_content(n_intervals):
    ...
    dev = html.Div([
            ...
            dbc.Row([
                    ...
                    dbc.Row([
                        dbc.Col([
                            html.P(f"UPDATES: {update_date}",className = col_title),
                        ...
                        dbc.Col([
                            ...
                            html.Hr(className = hr_class, style = hr_style),
                            html.P("TRENDS IN FATALITIES",className = col_title),
