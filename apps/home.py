...
#def load_dataset():
    #make variables availabe globally
    #global daily_updates_moh#, #county_daily_updates,data,daily_cases,age_gender_data,county_prevalence
...
# age_gender_cases_plot,age_gender_death_plot,total_female_cases,total_male_cases, \
#     perc_female_cases,perc_male_cases,total_female_death,total_male_death, \
#         perc_female_deaths,perc_male_deaths  = age_gender_plots2(age_gender_data),
...
layout = html.Div([
                    ...
                    ],justify="center",align = "center", className = "bg-secondary bg-opacity-10 g-1 justify-content-center"), #p-2 m-2
...
#             html.Div(id = "home-content2"),
            
#             dcc.Interval(id = "interval-component", interval = 3600 * 24 *1000, n_intervals = 0),      
# ])

# @app.callback(
#     Output("home-content2","children"), Input("interval-component", "n_intervals")
# )

# def update_content(n_intervals):
    
    #load_dataset()
    #return html.H1("I am 2home")
    ...
    #                 ],justify="center",align = "center", className = classname_col),
