...
layout = html.Div([
    ...
    dbc.Row([
        ...
        dbc.Col([
            ...
            dcc.Graph(figure=hm.cases_trend,responsive = True, style = {"width":"40vw","height":"20vh"}),
            
            html.P("Figure 3: Deaths Trends", className = "fst-italic fs-6 fw-bold mb-0"),
            dcc.Graph(figure = hm.deaths_trends,responsive = True, style = {"width":"40vw","height":"20vh"}),
        ],width=6),
